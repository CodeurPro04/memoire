...
<body>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Appoinment</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Appoinment</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="book-your-consulting rts-section-gap">
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="appoinment-area-main appoinment-page bg_image">
                        <h2 class="title mb--40">Make an Appoinment</h2>
                        <form action="#">
                            ...
                            <textarea class="mb--15" name="#" id="textarea" placeholder="text message"></textarea>
    ...
    <div class="short-service-area rts-section-gapBottom">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInRight" data-wow-delay=".2s" data-wow-duration=".8s">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".8s">
                    <a href="doctors-two.html" class="single-short-service">
                        <div class="icon">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInRight" data-wow-delay=".6s" data-wow-duration=".8s">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInRight" data-wow-delay=".8s" data-wow-duration=".8s">
