        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">High Risk Pregnancy</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">High Risk Pregnancy</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 pr--40 pr_md--10 pr_sm--15">
                    <div class="service-details-surgery-main">
                        <div class="thumbnail">
                            <img src="assets/images/service/42.webp" alt="service">
                        </div>
                        ...
                        <p class="disc">
                            ...
                            ophthalmologists utilize Personalized techniques and state-of-the-art technology to ensure
                        ...
                        <div class="row mt--40 g-5">
                            <div class="col-lg-12">
                                <div class="thumbnail">
                                    <img src="assets/images/service/40.webp" alt="service">
                                </div>
                            </div>
                        </div>
                    </div>
