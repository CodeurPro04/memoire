...
<body>
                                                        ...
                                                        <div class="row pl--30 pt--30">
                                                            <div class="col-lg-3">
                                                                <ul class="mega-menu-item">
                                                                    <li>
                                                                        <a href="optics-service-cataract.html">
                                                                            <img src="assets/images/service/29.svg" alt="service">Cataract </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="cornial-transplant.html">
                                                                            <img src="assets/images/service/30.svg" alt="service">Corneal
                                                                            Transplant</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="vision-theraphy.html">
                                                                            <img src="assets/images/service/31.svg" alt="service">Vision Therapy</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="dry-eye-treatment.html">
                                                                            <img src="assets/images/service/32.svg" alt="service">Dry Eye
                                                                            Treatment</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <ul class="mega-menu-item">
                                                                    <li>
                                                                        <a href="pediatric-care.html">
                                                                            <img src="assets/images/service/33.svg" alt="service">Pediatric Eye Care
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="laser-vision.html">
                                                                            <img src="assets/images/service/34.svg" alt="service">Laser Vision
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="medicine-theraphy.html">
                                                                            <img src="assets/images/service/23.svg" alt="service">Medicine
                                                                            Therapy</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="glass-treatment.html">
                                                                            <img src="assets/images/service/26.svg" alt="service">Glass
                                                                            Treatment</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                        ...
                                        <img src="assets/images/service/15.webp" alt="">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="menu-right-add">
                                                            <img src="assets/images/menu/04.webp" alt="">
    ...
    <!-- header area end -->
    <!-- banner area start -->
    <div class="rts-banner-area-two nine">
        <div class="swiper mySwiper-banner-2">
            <div class="swiper-wrapper">
                <!-- single swiper -->
                <div class="swiper-slide">
                    <div class="banner-wrapper-bg bg_image ptb--180 ptb_sm--100">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="banner-content-area style-two pl--0">
                ...
                <!-- single swiper -->
                <div class="swiper-slide">
                    <div class="banner-wrapper-bg bg-2-banner-2 bg_image ptb--180 ptb_sm--100">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="banner-content-area style-two pl--0">
                ...
                <!-- single swiper -->
                <div class="swiper-slide">
                    <div class="banner-wrapper-bg bg-2-banner-3 bg_image ptb--180 ptb_sm--100">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="banner-content-area style-two pl--0">
    ...
    <div class="rts-about-area rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="rts-about-left-nine wow move-right">
                        <img src="assets/images/about/01.webp" alt="about">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="about-inner-conetent-right-nine">
                        <div class="title-area-main-wrapper-left-nine">
                            <span class="pre-title wow fadeInUp">
                                <img src="assets/images/banner/icons/03.png" alt="">
                                Since 2004
                            </span>
                            <h2 class="title wow fadeInUp" data-wow-delay=".2s">Trusted Eye Care with Compassion &
                                Precision</h2>
                        </div>
                        <p class="disc wow fadeInUp" data-wow-delay=".4s">
                            we are dedicated to providing world-class eye care to patients of all ages. Our mission is
                            to enhance and protect your vision through advanced treatments, compassionate service, and a
                            commitment to excellence in eye health.
                        </p>
                        <div class="rating-area wow fadeInUp" data-wow-delay=".6s">
                            <img class="main" src="assets/images/about/02.webp" alt="">
                            <div class="rating-area">
                                <img src="assets/images/about/rating.webp" alt="">
                                <p>TrustScore 4.8 2k reviews</p>
                            </div>
                        </div>
                        <div class="button-bottom-about wow fadeInUp" data-wow-delay=".8s">
                            <a href="#" class="rts-btn btn-primary">About Us
                                <img src="assets/images/banner/icons/arrow--up-right.svg" alt="">
                            </a>
                            <div class="user-wrapper">
                                <img src="assets/images/about/user.webp" alt="user">
                                <div class="infor">
                                    <h4 class="title">50K+</h4>
                                    <span>Trusted patient</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Cataract Surgery</h4>
                        <p class="disc">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Corneal Transplant</h4>
                        <p class="disc">
                            Treatment of nervous system disorders, the brain & spinal cord.
                        </p>
                        <a href="service-details.html" class="btn-transparent">Learn More <i
                                class="fa-solid fa-arrow-right-long"></i></a>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".2s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Vision Therapy</h4>
                        <p class="disc">
                            Diagnosis and treatment of heart & cardiovascular conditions.
                        </p>
                        <a href="service-details.html" class="btn-transparent">Learn More <i
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Dry Eye Treatment</h4>
                        <p class="disc">
                            Diagnosis and treatment of heart & cardiovascular conditions.
                        </p>
                        <a href="service-details.html" class="btn-transparent">Learn More <i
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Pediatric Eye Care</h4>
                        <p class="disc">
                            Diagnosis and treatment of heart & cardiovascular conditions.
                        </p>
                        <a href="service-details.html" class="btn-transparent">Learn More <i
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".8s" data-wow-duration=".8s">
                    <div class="single-service-area">
                        ...
                        <h4 class="title">Laser Vision</h4>
                        <p class="disc">
                            Diagnosis and treatment of heart & cardiovascular conditions.
                        </p>
                        <a href="service-details.html" class="btn-transparent">Learn More <i
                        ...
                        <div class="container">
                            <div class="row align-items-end">
                                ...
                                <div class="col-xl-6 col-lg-6 offset-xl-1">
                                    <div class="why-choose-us-iamge-right-9 wow move-left">
                                        <img src="assets/images/about/03.webp" alt="about">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- rts large iamge area start -->
    <div class="rts-large-image-area-9 rts-large-iamge bg_image">
        <div class="rating-area-card">
            <div class="inner">
                <h3 class="title"> <span class="counter">27</span>+</h3>
                <img src="assets/images/video/02.webp" alt="video">
            </div>
        </div>
    </div>
    <!-- rts large iamge area end -->


    <div class="team-style-wrapper rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-between-area">
                        <div class="title-area-main-wrapper-left-nine">
                            <span class="pre-title wow fadeInUp">
                                <img src="assets/images/banner/icons/03.png" alt="doctors">
                                Our Doctors
                            </span>
                            <h2 class="title wow fadeInUp" data-wow-delay=".2s">Discover Expert <br> Team Member</h2>
                        </div>
                        <p class="disc">
                        ...
                        <form action="#">
                            ...
                            <div class="search-input">
                                ...
                                <div class="nice-select custom-select one" style="flex-basis: 50%;" tabindex="0">
                                    ...
                                    <ul class="list">
                                        <li data-value="Morning 10 AM" data-display="Morning 10 AM" class="option selected focus">Mr. Kadir</li>
                ...
                <div class="col-lg-12">
                    <div class="rts-find-application-area-inner  rts-section-gap">
                        ...
                        <div class="large-iamge move-up wow">
                            <img src="assets/images/appoinment/06.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
