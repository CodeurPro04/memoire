        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Dental Sedation</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Dental Sedation</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 pr--40 pr_md--10 pr_sm--15">
                    <div class="service-details-surgery-main">
                        <div class="thumbnail">
                            <img src="assets/images/service/30.webp" alt="service">
                        </div>
                        <h2 class="title">Dental Sedation, Renewed Quality of Life</h2>
                        <p class="disc">
                            Dental Sedation is a safe, effective procedure to restore Dental Sedation by removing the
