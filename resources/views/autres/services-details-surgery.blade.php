        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">General Surgery</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">General Surgery</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 pr--40 pr_md--10 pr_sm--15">
                    <div class="service-details-surgery-main">
                        ...
                        <h2 class="title">Comprehensive Surgical Care with a Focus on Safety and Recovery</h2>
                        <p class="disc">
                            Our General Surgery department provides a wide range of surgical procedures to treat common
                            health conditions and address various medical emergencies. With a focus on precision,
                            safety, and patient-centered care, our experienced surgeons use advanced techniques to
