...
<head>
    ...
    <style>
        ...
        .form {
            ...
            padding: 30px;
            width: 600px; /* Increased width to accommodate side-by-side fields */
            border-radius: 20px;
...
<body>
    <form class="form">
        ...
        <div class="field-row">
            <div class="field-column">
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Entrez votre date de naissance" class="input" type="date" required>
                </div>
            </div>
            <div class="field-column">
                <div class="flex-column">
        ...
        <div class="inputForm">
            ...
            <input placeholder="Entrez votre adresse" class="input" type="text" required>
        </div>
        ...
        <div class="inputForm">
            ...
            <input placeholder="Entrez votre numéro de sécurité sociale" class="input" type="text" required>
        </div>
        ...
        <div class="inputForm">
            ...
            <input placeholder="Entrez vos allergies" class="input" type="text">
        </div>
